...
INSERT INTO `t_genre_film` (`id_genre_film`, `fk_genre`, `fk_film`) VALUES
(3, 1, 3),
(4, 13, 3),
(5, 1, 16),
(6, 11, 5),
...
--
ALTER TABLE `t_genre_film`
  MODIFY `id_genre_film` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
--
...
--
ALTER TABLE `t_genre_film`
  ADD CONSTRAINT `t_genre_film_ibfk_1` FOREIGN KEY (`fk_genre`) REFERENCES `t_genres` (`id_genre`),
